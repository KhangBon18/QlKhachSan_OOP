...
public class App {
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            bookingService.loadInvoicesFromFile();
            ...
            do {
                ...
                System.out.println("4. Tinh hoa don");
                ...
                switch (choice) {
                    ...
                    case 4 -> bookingService.calculateInvoice(scanner);
    ...
    private static void search(Scanner scanner, RoomService roomService, BookingService bookingService) {
        ...
        do {
            ...
            System.out.println("2. Tim kiem phong theo so phong"); // Thêm lựa chọn tìm kiếm phòng theo số phòng
            System.out.println("3. Tim kiem dat phong theo ten khach hang");
            System.out.println("4. Tim kiem dat phong theo so dien thoai khach hang"); // Thêm lựa chọn tìm kiếm theo số điện thoại
            System.out.println("5. Tim kiem dat phong theo ngay");
            System.out.println("0. Quay lai menu chinh");
            System.out.print("Lua chon cua ban: ");
            ...
            switch (choice) {
                ...
                case 2 -> { // Thêm logic xử lý cho lựa chọn tìm kiếm phòng theo số phòng
                    System.out.print("Nhap so phong: ");
                    String roomNumber = scanner.nextLine();
                    roomService.searchRoomByNumber(roomNumber);
                }
                case 3 -> {
                ...
                case 4 -> { // Thêm logic xử lý cho lựa chọn tìm kiếm theo số điện thoại
                    System.out.print("Nhap so dien thoai khach hang: ");
                    String customerPhone = scanner.nextLine();
                    bookingService.searchBookingByCustomerPhone(customerPhone);
                }
                case 5 -> {
